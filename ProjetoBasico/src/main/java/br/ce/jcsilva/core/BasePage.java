...
/********* TextField e TextArea ************/
	...
	public void criarData(String id_campo, String dia, String mes, String ano){
		escrever(By.id(id_campo), dia + "/" + mes + "/" + ano);
	}
	...
	public boolean areMultipleChecksMarcados(String id1, String id2) {
		 WebElement checkbox1 = getDriver().findElement(By.id(id1));
		 WebElement checkbox2 = getDriver().findElement(By.id(id2));
